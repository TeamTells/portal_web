...
export class EmployeesDataService {
  ...
  public ConvertToDepartmentEntityList(departments: DepartmentDto[]): DepartmentEntity[] {
  ...
  public ConvertToDepartmentEntity(department: DepartmentDto): DepartmentEntity {
    return {
      id: department.id,
  ...
  public ConvertToEmployeeItemEntityList(employeeDtos: EmployeeDto[]): EmployeeItemEntity[] {
  ...
  public ConvertToEmployeeItemEntity(employee: EmployeeDto): EmployeeItemEntity {
    return {
      id: employee.id,
      img: employee.img,
      name: employee.name,
